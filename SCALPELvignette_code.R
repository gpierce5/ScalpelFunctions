...
outputFolder = "D:/Data/scalpeltest" #use linux slashes even in windows
...
dim(miniOut$Azero) #after step 1
dim(miniOut$A) #after step 2
dim(miniOut$Afilter) #after step 3

## ---- fig.width=2.5, fig.height=2.7, fig.align='center'------------------
plotVideoVariance(scalpelOutput = miniOut, neuronSet = "Afilter")
#Afilter specifies we want the output from step 3
#each column of Afilter is a neuron
